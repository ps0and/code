...
def show():
    ...
    st.markdown("""###### 💻 :blue[[문제 1]] 조건문을 사용해 `a > b`인 경우 메시지를 출력해보세요""")
    code_block_rows(1, "a = 10\nb = 3\nif a > b:\n    print('a는 b보다 크다')\nelse:\n    print('a는 b보다 작거나 같다')", prefix="d2_")

    st.markdown("""###### 💻 :blue[[문제 2]]  `num`이 짝수이면 `num은 짝수` 홀수이면 `num은 홀수`가 출력되도록 코드를 작성하세요.""")
    ...
    st.markdown("""###### 💻 :blue[[문제 3]] 1부터 10까지 숫자를 출력하는 코드를 작성하세요""")
    with st.expander("💡 정답 보기"):
        st.markdown("""```python\nfor i in range(1, 11):\n    print(i)\n```""")
    code_block_columns(3, "for i",prefix="d2_")

    st.markdown("""###### 💻 :blue[[문제 4]] 1부터 5까지의 합을 구하는 코드를 작성하세요""")
    with st.expander("💡 힌트 보기"):
    ...
    st.markdown("###### 💻 :blue[[도전 문제1]] 1부터 100 사이의 짝수만 리스트에 담고 출력해보세요")
    with st.expander("💡 힌트 보기"):
    ...
    st.markdown("###### 💻 :blue[[도전 문제2]] 1부터 10까지 수 중 3의 배수의 합을 구하세요")
    with st.expander("💡 힌트 보기"):
